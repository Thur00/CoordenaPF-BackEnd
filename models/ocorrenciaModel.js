...
async function createOcorrencias(ocorrencias) {
    const { Criador, Data_ocorrencia, Hora, Iniciativa, Aspecto, Urgencia, Tema, Turma, Estudantes, Rm_aluno, Responsável, Descricao, Encaminhamento, Status } = ocorrencias;  // Extrai o categoria do Status do objeto passado como parâmetro
